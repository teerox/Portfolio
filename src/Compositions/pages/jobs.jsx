...
export default function Jobs() {
    ...
    const allData = [
        ...
                "description": "Collaborated with team members to build a full-stack mobile Investment application based on client requirements., used for connecting interested Individual willing to invest in Africa. yet to be launched and Deployed of Play store and App Store.",
                "tools": " java swift github",
                "link": "",
